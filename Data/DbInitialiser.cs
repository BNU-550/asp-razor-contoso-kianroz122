...
namespace ASP_RazorContoso.Data
{
    public class DbInitialiser
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            {
                new Course{CourseID=1050,Title="Web Development",Credits=3},
                ...
                new Course{CourseID=3141,Title="Archetecural Technology",Credits=4},
                new Course{CourseID=2021,Title="Accounting and Finance",Credits=3},
                new Course{CourseID=2042,Title="Air Transport",Credits=4}
            };
